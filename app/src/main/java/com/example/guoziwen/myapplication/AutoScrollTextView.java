...
public class AutoScrollTextView extends View
{
	...
	private int mTextSize = sp2px(78);
...
//		drawNext(canvas);
	...
	{
		int y = getMeasuredHeight() * 3 / 2 + mTextHeight / 2;
		canvas.drawText(mNextNum + "", mTextCenterX, y ,
				mPaint);
	}

	private void drawSelf(Canvas canvas)
	{
		int y = getMeasuredHeight() / 2 + mTextHeight / 2;
		canvas.drawText(mCurNum + "", mTextCenterX, y , mPaint);
	}
